    ...
    <asp:UpdatePanel runat="server" id="mainupdatepanel">
        <ContentTemplate>
            <table class="table table-override">
                <tr>
                    <td width="30%">Type of Loan:
            </td>
                    <td width="70%">
                        <asp:DropDownList ID="DDType" runat="server" class="form-control" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="DDType_SelectedIndexChanged">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:DropDownList ID="AllowedAmountDropDownList" runat="server" CssClass="form-control">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
